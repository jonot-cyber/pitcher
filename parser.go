...
// Parse takes a reader for a markdown file and parses it
...
// parseSection takes in a section (array of strings) and parses it out
...
// parseRest parses the rest of the document, mostly through regexes
...
// parseTitle parses a title and returns its text contents
